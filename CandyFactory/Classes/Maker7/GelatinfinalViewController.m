...
@implementation GelatinfinalViewController
...
- (id)init
{
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        self = [super initWithNibName:@"GelatinfinalViewController-iPad" bundle:[NSBundle mainBundle]];
    else if([[UIScreen mainScreen] bounds].size.height == 568)
        self = [super initWithNibName:@"GelatinfinalViewController-5" bundle:[NSBundle mainBundle]];
    else
        self = [super initWithNibName:@"GelatinfinalViewController" bundle:[NSBundle mainBundle]];
...
- (void)viewDidLoad
{
      ...
      [Flurry logEvent:@"Gelatin_Created"];
...
- (void) saveToGallery:(NSTimer *) theTimer
{
    ...
    NSString * nameOfCandy = [NSString stringWithFormat:@"gelatin%d",[array count]];
    NSString * CandyBackImage = [NSString stringWithFormat:@"gelatinBack%d",[array count]];
    NSString * maskImage2 = [NSString stringWithFormat:@"gelatinMask%d",[array count]];
    NSMutableDictionary * newCandy = [[NSMutableDictionary alloc]init];
    [newCandy setObject:@"7" forKey:@"type"];
