//
//  CandyAppleWaterViewController.h
//  CandyFactory
//
...
@interface CandyAppleWaterViewController : UIViewController
{
    BOOL _isPouring;
...
@property(nonatomic,retain) IBOutlet UIImageView *waterBottle;
@property(nonatomic,retain) IBOutlet UIImageView *waterPouring;
