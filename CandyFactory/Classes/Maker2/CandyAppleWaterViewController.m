...
- (id)init
{
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        self = [super initWithNibName:@"CandyAppleWaterViewController-iPad" bundle:[NSBundle mainBundle]];
    else if([[UIScreen mainScreen] bounds].size.height == 568)
        self = [super initWithNibName:@"CandyAppleWaterViewController-5" bundle:[NSBundle mainBundle]];
    else
        self = [super initWithNibName:@"CandyAppleWaterViewController" bundle:[NSBundle mainBundle]];
...
{
    CandyAppleSugarViewController *flavour = [[CandyAppleSugarViewController alloc] init];
